...
private:
    void uniqueFileName(QFile &file, QString &name, QString &type,
                        const QString &path);
...
private:
    bool filterChildIndex(QFileSystemModel *model, int source_row,
                          const QModelIndex &source_parent) const;
    bool isSubdirectory(const QString &subDirPath,
